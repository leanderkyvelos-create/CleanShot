...
## Projektstruktur
- `Package.swift` – SwiftPM Manifest (iOS 16+ / macOS 13+). Wichtig, weil der integrierte PhotosPicker erst ab iOS 16 bzw. macOS 13 verfügbar ist.
...
## Aufbau
1. Öffne das Repository in Xcode (iOS 16+ oder macOS 13+). SwiftPM erzeugt die App automatisch.
...
- Installation: In Xcode über "Product > Run" auf einem iOS-16+-Gerät/Simulator oder unter macOS 13+.
